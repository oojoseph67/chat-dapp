...
export function MessageList({ selectedFriend }: MessageListProps) {
  ...
  const sortedDateKeys = useMemo(() => {
    return sortDateGroups(groupedMessages);
  }, [groupedMessages]);
      ...
      {sortedDateKeys.map((dateKey) => (
        <div key={dateKey} className="space-y-4">
          ...
          <div className="flex justify-center">
            <div className="bg-gray-100 dark:bg-gray-800 text-gray-600 dark:text-gray-400 text-xs font-medium px-3 py-1 rounded-full">
